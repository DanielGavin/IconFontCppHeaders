...
class LanguageOdin( Language ):
    language_name = 'Odin'
    file_name = 'Icons{name}.odin'
    ...
    def prelude( cls ):
        ...
        result += 'Icons{name} := Font'.format( name = str( cls.intermediate.get( 'font_name' )).replace( ' ', '' ) )
        result += '{\n'
...
languages = [ LanguageC, LanguageCSharp, LanguagePython, LanguageRust, LanguageGo, LanguageOdin ]
